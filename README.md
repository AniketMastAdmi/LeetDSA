...
|---|---|---|---|---|
| 33 | [Search in Rotated Sorted Array](https://github.com/AniketMastAdmi/LeetDSA/blob/main/LeetCode/Medium/0033_Search_in_Rotated_Sorted_Array/solution.txt) | Medium | 1class Solution:
2    def search(self, nums: List[int], target: int) -> int:
3        n = len(nums)
4        low,high = 0, n - 1
5        
